...
checkpoint = torch.load('../checkpoint/COVERAGE/COVERAGE.pth', map_location='cpu')
...
# Please put the COVERAGE test dataset path in fileList
...
print('AUC:%3.6f F1:%3.6f B_F1:%3.6f ERR:%3.6f ACC:%3.6f' % \
      ((val_auc / 25), (val_f1 / 25),(val_best_f1 / 25), (val_eer / 25), (acc / 25)))
