...
checkpoint = torch.load('../checkpoint/NIST16/NIST16.pth', map_location='cpu')
...
# Please put the NIST16 test dataset path in fileList
...
print('AUC:%3.6f F1:%3.6f B_F1:%3.6f ERR:%3.6f ACC:%3.6f' % \
      ((val_auc / 160), (val_f1 / 160),(val_best_f1 / 160), (val_eer / 160), (acc / 160)))
