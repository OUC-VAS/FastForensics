...
checkpoint = torch.load('../checkpoint/Columbia/Columbia.pth', map_location='cpu')
...
# Please put the Columbia dataset path in fileList
...
print('AUC:%3.6f F1:%3.6f B_F1:%3.6f ERR:%3.6f ACC:%3.6f' % \
      ((val_auc / 180), (val_f1 / 180),(val_best_f1 / 180), (val_eer / 180), (acc / 180)))
